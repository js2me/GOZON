...
const actionButtonCx = cva('inline-flex items-center justify-center', {
  variants: {
    look: {
      solidBrand:
        'rounded-xl bg-brand font-semibold text-white shadow-none hover:bg-brand/90 disabled:text-white/70',
      solidBrandIcon:
      ...
      ghostNeutral:
        'gap-1 rounded-md px-0 py-0 font-inherit text-[13px] text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-800',
      ghostRisk:
      ...
      linkAccent:
        'rounded-md px-0 py-0 font-medium text-[13px] text-brand transition-colors hover:underline',
      linkMuted:
  ...
  compoundVariants: [
    ...
    { look: 'ghostBrand', textMode: 'icon', size: 'l', class: 'h-12 w-12 shrink-0' },
    { look: 'surface', textMode: 'icon', size: 'm', class: 'size-8' },
    { look: 'surface', textMode: 'icon', size: 'l', class: 'h-12 w-12 shrink-0' },
    {
      look: 'ghostNeutral',
      textMode: 'withText',
      class: 'gap-1.5 hover:bg-transparent hover:text-slate-800',
    },
    {
      textMode: 'withText',
      size: 'm',
      look: 'solidBrand',
      class: 'h-10 shrink-0 gap-2 px-4 text-sm',
    },
    {
      textMode: 'withText',
      size: 'l',
...
const extraLabelToneCx = cva('block whitespace-nowrap font-medium leading-tight', {
  variants: {
    size: {
      m: 'text-[12px]',
      l: 'text-[15px]',
      ...
      <>
        ...
        {hasExtraText ? (
          <span className="inline-flex flex-col leading-none">
            ...
            <span className={extraLabelToneCx({ size, tone })}>{extraText}</span>
          </span>
        ) : (
          <span className={cx(labelCx({ size }), 'whitespace-nowrap')}>
            {text}
